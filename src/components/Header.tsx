      ...
      <div className="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
        ...
        {props.isLoggedIn && (
          <div className="flex items-center gap-3 2xsm:gap-7">
            {window.location.pathname !== "/p/cart" && (
              <Link
                to="/p/cart"
                className="m-2 p-4 inline-flex items-center justify-center rounded bg-blue-600 py-2 px-3 text-center font-medium text-white hover:bg-opacity-90 lg:px-4 xl:px-5 sm:px-3 xs:px-2 relative"
              >
                <span>
                  <svg
                ...
                <span className="absolute top-0  right-0 bg-white w-4 h-4 text-xs  text-center rounded-full text-black">
                  {props.cartLength}
                </span>
              </Link>
            )}
        ...
        {!props.isLoggedIn && (
          <div className="flex items-center gap-3 2xsm:gap-7">
            <Link
              to="/login"
              className="m-2 inline-flex items-center justify-center rounded bg-blue-600 py-2 px-3 text-center font-medium text-white hover:bg-opacity-90 lg:px-4 xl:px-5 sm:px-3 xs:px-2"
            >
              Login
            </Link>
          </div>
